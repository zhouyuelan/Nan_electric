...
import ClientDetails from "@/pages/Client/ClientDetails.vue";
import UserTimeTotal from "@/pages/UseTimeTotal/index.vue";
import PeopleTotal from "@/pages/PeopleTotal/index.vue";
...
export const routes: RouteRecordRaw[] = [
	...
	},
	{
		name: "基础信息", redirect: "/1", path: "/1", children: [
			...
			{ name: "客户信息编辑", path: "/ClientDetails", component: ClientDetails },
	...
	},
	{
		name: "设备报修", redirect: "", path: "/2", children: [
			{ name: "新增报修", path: "/client2", component: Client },
	...
	},
	{
		name: "设备巡检", redirect: "", path: "/3", children: [
			{ name: "新增巡检", path: "/client3", component: Client },
	...
	},
	{
		name: "设备整改", redirect: "", path: "/4", children: [
			{ name: "新增整改", path: "/client4", component: Client },
	...
	},
	{
		name: "运营报表", redirect: "", path: "/5", children: [
			{ name: "用时统计", path: "/use_time_total", component: UserTimeTotal },
			{ name: "人员统计", path: "/people_total", component: PeopleTotal },
