...
const initRepairsCharts = () => {
	const repairsCharts = proxy?.echarts.init(document.getElementById("repairsCharts"));
...
const initPollingCharts = () => {
	const pollingCharts = proxy.echarts.init(document.getElementById("pollingCharts"));
...
const initUpdateCharts = () => {
	const updateCharts = proxy.echarts.init(document.getElementById("updateCharts"));
